...
const ProductCard = ({data}) => {
  ...
  return (
  <>
     <div className='w-full h-[370px] rounded-lg shadow-sm p-3 relative cursor-pointer '>
        ...
        <h4 className='pb-3 font-[500]'>
            {  
            data.name.length > 40  ? data.name.slice(0,40) +  "..." : data.name // in this if length greater show with ... not then show full name
            }
            </h4>
