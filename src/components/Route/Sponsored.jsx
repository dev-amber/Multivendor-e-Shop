  ...
  return (
    <div  className={`${styles.section} hidden sm:block bg-white py-10 px-5 mb-12 cursor-pointer rounded-xl`}>
     <div className='flex justify-between w-full'>
       ...
       <div className='flex items-start'>
       <img src='https://s.yimg.com/fz/api/res/1.2/jDeOlWJEwLQciYlKHuK0Xw--~C/YXBwaWQ9c3JjaGRkO2ZpPWZpbGw7aD00MTI7cHhvZmY9NTA7cHlvZmY9MTAwO3E9ODA7c3M9MTt3PTM4OA--/https://i.pinimg.com/736x/45/c2/e3/45c2e34a005874528f84da3b4dca7bb1.jpg'
       ...
       <div className='flex  items-start'>
       <img src='https://sp.yimg.com/ib/th/id/OIP.GzDl4lbn0PYYeSNiCFVRvgHaFj?pid=Api&w=148&h=148&c=7&dpr=2&rs=1'
        style={{
            width:  "100px",
            objectFit:"contain"
        }}
